...
```bash
scientific-report-console project scientific-report.canonical.json \
...
scientific-report-console validate scientific-report.public.json \
...
scientific-report-console render scientific-report.public.json \
  --source-report scientific-report.canonical.json \
  --projection disclosure-projection.json \
  --artifact-root . \
  --out report-bundle

scientific-report-console verify report-bundle
```
...
Use the installed `scientific-report-console/generation` APIs outside the model layer:
